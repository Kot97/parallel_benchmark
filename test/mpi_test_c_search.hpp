...
class CMpiSearchTest : public ::testing::TestWithParam<
...
INSTANTIATE_TEST_SUITE_P(Small, CMpiSearchTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(Medium, CMpiSearchTest, ::testing::Values(
...
INSTANTIATE_TEST_SUITE_P(Large, CMpiSearchTest, ::testing::Values(
...
#define C_MPI_TEST_SEARCH(test_name, function_name)\
TEST_P(CMpiSearchTest, test_name)\
{\
