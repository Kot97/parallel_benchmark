...
#define MPI_TEST_NULL_INPUT(test_name, function_name)\
TEST(NullInput, test_name)\
{\
    mpi::communicator comm;\
    function_name(comm, NULL, NULL, NULL, 0);\
    function_name(comm, nullptr, nullptr, nullptr, 0);\
}

#define MPI_TEST_VECTOR_MULT(test_name, function_name)\
